...
export default function FeaturesSection() {
	return (
		<section className="relative">
			{/* Particles animation */}
			<div className="absolute left-1/2 -translate-x-1/2 top-0 -z-10 w-64 h-64 -mt-24"></div>
					...
					<div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
						...
						<div className="bg-gradient-to-tr from-slate-800/50 to-slate-800/10 rounded-3xl border border-slate-800">
							<div className="flex items-center space-x-4 p-4 h-full">
								...
								<p className="text-sm text-slate-400">
									There&apos;s no prioritized support in Stellar. You can use
									email or live chat and you will hear back in a{" "}
									<strong className="text-slate-300 font-medium">
										couple of hours
									</strong>
									.
						...
						<div className="bg-gradient-to-tr from-slate-800/50 to-slate-800/10 rounded-3xl border border-slate-800">
							<div className="flex items-center space-x-4 p-4 h-full">
								...
								<p className="text-sm text-slate-400">
									No upcharges—and we&apos;d never upsell you to a higher plan
									or a{" "}
									<strong className="text-slate-300 font-medium">
										dedicated IP
									</strong>{" "}
