		...
		<main className="container mx-auto px-4 py-6">
				...
				<Card className="sticky top-24 overflow-hidden bg-white dark:bg-neutral-900 shadow-xl">
					...
					<CardContent className="pt-6">
						<div className="flex justify-between items-center mb-4">
							<div className="text-3xl font-bold text-aviatorjonah-600 dark:text-aviatorjonah-400">
						...
						<PaymentClient
							...
							buttonStyles={"bg-aviatorjonah-600 hover:bg-aviatorjonah-700 text-white"}
			...
			<div className="grid lg:grid-cols-3 gap-8">
				<div className="md:col-span-2">
					<h1 className="text-4xl font-bold mb-4 text-aviatorjonah-600 dark:text-aviatorjonah-400">
						{course.title}
					</h1>
					...
					<div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-6">
						<div className="flex items-center space-x-2 bg-white dark:bg-neutral-800 p-3 rounded-lg shadow-md">
							<BookOpen className="h-5 w-5 text-aviatorjonah-500" />
							<span>{course.category}</span>
						</div>
						<div className="flex items-center space-x-2 bg-white dark:bg-neutral-800 p-3 rounded-lg shadow-md">
							<Clock className="h-5 w-5 text-aviatorjonah-500" />
							<span>{Math.ceil((course.completion_time ?? 0) / 60)} hours</span>
						</div>
						<div className="flex items-center space-x-2 bg-white dark:bg-neutral-800 p-3 rounded-lg shadow-md">
							<BarChart className="h-5 w-5 text-aviatorjonah-500" />
											...
											{module.lessons
												...
												.map((lesson) => (
													...
													>
														...
														<div className="text-sm text-aviatorjonah-600 dark:text-aviatorjonah-400 mt-1">
