          ...
          <div className="lg:col-span-2">
              ...
              <CardContent className="pt-6">
                <div className="flex items-center space-x-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-neutral-600 dark:text-neutral-400">
                      ...
                      course. Don&apos;t worry, we&apos;re here to help you resolve this
                      issue.
                    </p>
                  </div>
                </div>
                <div className="mt-6 space-y-4">
                  <PaymentClient
                    ...
                    buttonStyles={"bg-indigo-600 hover:bg-indigo-700 text-white mb-0"}
                    enrolled={false}
            ...
            <Accordion type="single" collapsible className="w-full mb-8">
              <AccordionItem value="item-1">
                ...
                <AccordionContent>
                  Ensure you have a stable internet connection. Try refreshing
                  the page or reconnecting to your network before attempting to
                  enroll again.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-2">
                ...
                <AccordionContent>
                  Clearing your browser&apos;s cache and cookies can often
                  resolve enrollment issues. After clearing, restart your browser
                  and try enrolling again.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-3">
                ...
                <AccordionContent>
                  ...
                  information is up-to-date and that there are no issues with
                  your payment method.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
            ...
            <Card className="sticky top-24 overflow-hidden bg-white dark:bg-neutral-900 shadow-xl mb-6">
              <CardContent className="pt-6">
                ...
                <p className="text-neutral-600 dark:text-neutral-400 mb-4">
                  Our support team is available to help you resolve any
                  enrollment issues.
                </p>
